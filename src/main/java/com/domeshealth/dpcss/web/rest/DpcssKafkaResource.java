...
@RestController
@RequestMapping("/api/dpcss-kafka")
public class DpcssKafkaResource {
    private final Logger log = LoggerFactory.getLogger(DpcssKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DpcssKafkaResource(KafkaProperties kafkaProperties) {
